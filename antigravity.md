...
- **Multi-Level Quick Sets (13 Jun):**
  - เพิ่มทางลัดให้บันทึกเป็นชุดด่วนได้จากทั้ง Level 1 (สำรวจอารมณ์), Level 2 (สแกนกาย-ใจ) และ Level 3 (จับแยกขันธ์ 5)
  - เพิ่ม UI Modal เลือกระดับที่ต้องการในหน้า Home (เมื่อกด "เพิ่มด่วน")
  - ระบบทำงานแบบ Pre-filled Form: เมื่อกดชุดด่วนจาก Home จะนำข้อมูลที่เซฟไว้ไปกรอกล่วงหน้าในหน้าระดับนั้นๆ แล้วรอให้ผู้ใช้เช็คและกดยืนยันเอง
